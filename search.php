 ...
 * @package    Mannering mannering-storefront-child-theme Child Theme
...
<h1 class="page-title">
	...
	printf( esc_html_e( 'Search Results for: %s', 'mannering-storefront-child-theme' ), '<span>' . get_search_query() . '</span>' );
	?>
</h1>
</header><!-- .page-header -->
